...
export default function Login() {
  ...
  const handleForgotPassword = async (e) => {
    ...
    setInfo('')
    setBusy(true)
    // Usa a URL atual (funciona tanto local quanto publicado, incluindo
    // subpasta do GitHub Pages) como destino do link de redefinição.
    ...
    if (resetError) {
      ...
      setInfo('Se esse e-mail estiver cadastrado, enviamos um link para você redefinir a senha. Confira também a caixa de spam.')
    }
  }
        ...
        {mode === 'forgot' ? (
          <form onSubmit={handleForgotPassword}>
            <p className="sub" style={{ marginTop: -8 }}>
              Informe o e-mail da sua conta — vamos te enviar um link para escolher uma senha nova.
            </p>
            <div className="field">
